...
<div class=" ">
    ...
    <div v-if="agregarEmpleadoModal" id="defaultModal" aria-hidden="true" class="fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div id="">
                        ...
                        <input v-model="nombre" class="px-2 py-2 border rounded w-full " type="text">
                    </div>

                    <div id="">
                        <label class="block">Apellido </label>
                        <input v-model="apellido" class="px-2 py-2 border rounded " type="text">
                    </div>
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button @click="agregarDatos({nombre, apellido, email, whatsapp })" data-modal-hide="defaultModal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I accept</button>
    ...
    <div class="container mx-auto pl-64 pt-10">
        ...
        <div class="mx-3">
            <div class="flex justify-end ">
                <button @click="agregarEmpleadoModal = !agregarEmpleadoModal" class="bg-teal-900 text-white px-2 py-1 rounded">
                    Agregar
                </button>
            </div>
