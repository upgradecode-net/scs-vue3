...
<template>
    <div class=" ">
        ...
        <!-- Main modal -->
        <div v-if="agregarEmpleadoModal" id="defaultModal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-100  w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
        ...
        <div class="container mx-auto pl-64 pt-10">
            <div class="mx-3 border p-4 rounded  ">
                ...
                <button @click="agregarEmpleadoModal = !agregarEmpleadoModal" data-modal-target="default"
